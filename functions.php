...
if ( ! function_exists( 'pera_setup' ) ) :
	...
	function pera_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'pera' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'pera_custom_background_args', array(
...
add_action( 'after_setup_theme', 'pera_setup' );
 ...
 */
function pera_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'pera_content_width', 640 );
}
add_action( 'after_setup_theme', 'pera_content_width', 0 );
...
add_action( 'widgets_init', 'pera_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function pera_scripts() {
	wp_enqueue_style( 'pera-style', get_stylesheet_uri() );
...
add_action( 'wp_enqueue_scripts', 'pera_scripts' );
